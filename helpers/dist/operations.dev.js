...
var addNumber = function addNumber() {
  ...
  if (display2.textContent === "0 - " || display2.textContent === "0 * ") {
    (0, _status.setOperation)() === "subtract" ? (0, _status.setAccumulated)((0, _status.setAccumulated)() - formatNumber(displayText.textContent)) : (0, _status.setAccumulated)((0, _status.setAccumulated)() * formatNumber(displayText.textContent));
    display2.textContent = "".concat((0, _status.setAccumulated)(), " + ");
    (0, _status.setCounter)(1);
  ...
  if ((0, _status.setOperation)() !== "add" && (0, _status.setOperationStatus)()) {
...
var subtractNumber = function subtractNumber() {
  console.log((0, _status.setOperationStatus)());
  if ((0, _status.setOperation)() === "error") return;

  if (display2.textContent === "0 + " || display2.textContent === "0 * ") {
    (0, _status.setOperation)() === "add" ? (0, _status.setAccumulated)((0, _status.setAccumulated)() + formatNumber(displayText.textContent)) : (0, _status.setAccumulated)((0, _status.setAccumulated)() * formatNumber(displayText.textContent));
    display2.textContent = "".concat((0, _status.setAccumulated)(), " - ");
    (0, _status.setCounter)(1);
  ...
  if ((0, _status.setOperation)() !== "subtract" && (0, _status.setOperationStatus)()) {
...
var multiplyNumber = function multiplyNumber() {
  ...
  if ((0, _status.setOperation)() !== "multiply" && (0, _status.setOperationStatus)()) {
    displayText.textContent = 0;
    (0, _status.setAccumulated)((0, _status.setAccumulated)() + formatNumber(displayText.textContent));
    (0, _status.setCounter)(1);
    (0, _status.setOperation)("multiply");
...
var divideNumber = function divideNumber() {
  ...
  if ((0, _status.setOperation)() !== "divide" && (0, _status.setOperationStatus)()) {
    displayText.textContent = 0;
    (0, _status.setAccumulated)((0, _status.setAccumulated)() + formatNumber(displayText.textContent));
    (0, _status.setCounter)(1);
    (0, _status.setOperation)("divide");
